 ...
 * sequentially on the ONE {@link app.wheelstop.android.automation.AutomationQueue} worker
...
public final class AcAutoOffTimer {
     ...
     */
    private static final String STATE_PATH = "/data/local/tmp/wheelstop_ac_auto_off_due";
