package app.wheelstop.android.daemon.camera
...
class CameraManager(
    ...
    fun setStreamingQuality(quality: String) {
        val streamQuality = when (quality.uppercase()) {
            "HQ" -> app.wheelstop.android.surveillance.GpuPipelineConfig.StreamingQuality.HQ
            "LQ" -> app.wheelstop.android.surveillance.GpuPipelineConfig.StreamingQuality.LQ
            else -> app.wheelstop.android.surveillance.GpuPipelineConfig.StreamingQuality.HQ
        }
    ...
    fun setRecordingMode(mode: String) {
        val recordingMode = when (mode.uppercase()) {
            "NORMAL" -> app.wheelstop.android.surveillance.GpuPipelineConfig.RecordingMode.NORMAL
            "SENTRY" -> app.wheelstop.android.surveillance.GpuPipelineConfig.RecordingMode.SENTRY
            else -> app.wheelstop.android.surveillance.GpuPipelineConfig.RecordingMode.NORMAL
        }
