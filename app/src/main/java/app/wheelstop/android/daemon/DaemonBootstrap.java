...
public final class DaemonBootstrap {
    ...
    private static final String BOOTSTRAP_PACKAGE = "app.wheelstop.android";
    ...
    private static boolean verifySafeWorking() {
        try {
            Class<?> encClass = Class.forName("app.wheelstop.android.daemon.proxy.Enc");
            Field appPackageField = encClass.getDeclaredField("APP_PACKAGE");
            String decrypted = (String) appPackageField.get(null);
            
            // If decryption works, it should return "app.wheelstop.android"
