...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/daemon/CameraDaemon.java
import app.wheelstop.android.abrp.AbrpConfig;
import app.wheelstop.android.abrp.AbrpTelemetryService;
...
import app.wheelstop.android.server.SurveillanceIpcServer;
import app.wheelstop.android.server.TcpCommandServer;
=======
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/daemon/CameraDaemon.java
...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/daemon/CameraDaemon.java
        memoryLogScheduler.scheduleAtFixedRate(() -> {
            try {
                app.wheelstop.android.server.RecordingsApiHandler.pruneRecordingCache();
            } catch (Throwable t) {
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/daemon/CameraDaemon.java
     ...
     *   - some launchers append "app.wheelstop.android.daemon.CameraDaemon"
    ...
    private static boolean isCameraDaemonCmdline(String cmdline) {
        ...
        return cmdline.contains("byd_cam_daemon")
            || cmdline.contains("app.wheelstop.android.daemon.CameraDaemon");
    }
            ...
            try {
                ...
                if (classpath != null) {
                    ...
                    for (String path : paths) {
                        if (path.contains("app.wheelstop.android") && path.endsWith(".apk")) {
                            apkPath = path;
                            break;
                        }
                    }
        ...
        for (String perm : permissions) {
            try {
                Process process = Runtime.getRuntime().exec(
                    "pm grant app.wheelstop.android " + perm);
