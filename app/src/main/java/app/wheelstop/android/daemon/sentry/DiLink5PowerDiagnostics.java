...
import app.wheelstop.android.camera.dilink5.TsAvmCoordinator;
import app.wheelstop.android.logging.DaemonLogger;
import app.wheelstop.android.util.WakeLockManager;
...
public class DiLink5PowerDiagnostics {
    ...
    public static synchronized void start(Context context) {
        ...
        try {
            Runtime.getRuntime().exec(new String[]{"dumpsys", "deviceidle", "whitelist", "+app.wheelstop.android"});
