...
public class RecordingsApiHandler {
    ...
    private static final String LEGACY_RECORDINGS_DIR = "/storage/emulated/0/Android/data/app.wheelstop.android/files";
    ...
    private static void deleteSidecars(File mp4File, String filename) {
        ...
        // DELETE event.
        try {
            app.wheelstop.android.server.RecordingsIndex.getInstance().remove(filename);
        } catch (Throwable ignored) {
