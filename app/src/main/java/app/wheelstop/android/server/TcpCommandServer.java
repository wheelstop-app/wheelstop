    ...
    private JSONObject processCommand(JSONObject cmd) throws Exception {
        ...
        switch (action) {
            ...
            case "setRecordingsStorageType":
                ...
                app.wheelstop.android.storage.StorageManager.StorageType recType = null;
                switch (recStorageTypeValue) {
                    case "INTERNAL": recType = app.wheelstop.android.storage.StorageManager.StorageType.INTERNAL; break;
                    case "SD_CARD":  recType = app.wheelstop.android.storage.StorageManager.StorageType.SD_CARD;  break;
                    case "USB":      recType = app.wheelstop.android.storage.StorageManager.StorageType.USB;      break;
                }
                if (recType != null) {
            ...
            case "setRecordingsLimitMb":
                ...
                if (recLimitMb > 0) {
                    app.wheelstop.android.storage.StorageManager recLimitStorage =
                        app.wheelstop.android.storage.StorageManager.getInstance();
            ...
            case "auth_invalidate":
                ...
                app.wheelstop.android.auth.AuthManager.invalidateCache();
