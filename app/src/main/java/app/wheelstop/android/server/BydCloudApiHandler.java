...
public class BydCloudApiHandler {
    ...
    private static void handleStatus(OutputStream out) throws Exception {
        ...
        // Cloud push status
        status.put("cloudPush", app.wheelstop.android.byd.cloud.BydCloudDataProvider.getInstance().getStatusJson());
    ...
    private static void handleSettings(OutputStream out, String body) throws Exception {
        ...
        try {
            ...
            app.wheelstop.android.byd.cloud.BydCloudDataProvider.getInstance().syncPollerState();
