...
import app.wheelstop.android.remote.RemoteDevViewBridgeAuth;
import app.wheelstop.android.remote.RemoteDevViewBridgeService;
...
final class RemoteDevViewBridgeClient {
    ...
    Response start(boolean launchActivity) {
