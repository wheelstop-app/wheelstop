...
public class SurveillanceIpcServer implements Runnable {
    ...
    private static volatile app.wheelstop.android.abrp.AbrpConfig abrpConfig;
    private static volatile app.wheelstop.android.abrp.AbrpTelemetryService abrpService;

    public static void setAbrpReferences(app.wheelstop.android.abrp.AbrpConfig config, app.wheelstop.android.abrp.AbrpTelemetryService service) {
        abrpConfig = config;
        abrpService = service;
    }
    ...
    private static volatile app.wheelstop.android.mqtt.MqttConnectionManager mqttManager;

    public static void setMqttManager(app.wheelstop.android.mqtt.MqttConnectionManager manager) {
        mqttManager = manager;
    }
        ...
        try {
            ...
            switch (command) {
                ...
                case "STATUS": {
                    ...
                    boolean enabled = app.wheelstop.android.config.UnifiedConfigManager.isSurveillanceEnabled();
                ...
                case "UPDATE_SECTION": {
                    ...
                    if (!s.isEmpty() && data != null) {
                        synchronized (CONFIG_LOCK) {
                            ...
                            ok = app.wheelstop.android.config.UnifiedConfigManager.updateSection(s, data);
                        }
                    }
                ...
                case "UPDATE_VALUES": {
                    ...
                    if (!s.isEmpty() && values != null) {
                        ...
                        synchronized (CONFIG_LOCK) {
                            app.wheelstop.android.config.UnifiedConfigManager.forceReload();
                            ok = app.wheelstop.android.config.UnifiedConfigManager.updateValues(s, map);
                        }
                    }
                    response.put("success", ok);
                    break;
                ...
                case "EXPORT_CONFIG": {
                    ...
                    JSONObject bundle = app.wheelstop.android.config.ConfigBackupService.buildBundle(
                            app.wheelstop.android.updater.AppUpdater.getInstalledVersion(),
                            deviceModelString(),
                ...
                case "REPLACE_CONFIG": {
                    ...
                    app.wheelstop.android.config.ConfigBackupService.ApplyResult res;
                    synchronized (CONFIG_LOCK) {
                        res = app.wheelstop.android.config.ConfigBackupService.applyBundle(
                                bundle,
                                app.wheelstop.android.updater.AppUpdater.getInstalledVersion(),
                                deviceModelString());
                    }
                ...
                case "GET_SAFE_LOCATIONS":
                    response = app.wheelstop.android.surveillance.SafeLocationManager.getInstance().getStatusJson();
                    response.put("success", true);
                    break;
                ...
                case "ADD_SAFE_LOCATION": {
                    ...
                    if (zoneData != null) {
                        app.wheelstop.android.surveillance.SafeLocation zone =
                            app.wheelstop.android.surveillance.SafeLocationManager.getInstance().addZone(
                ...
                case "UPDATE_SAFE_LOCATION": {
                    ...
                    if (zoneId != null && updates != null) {
                        boolean updated = app.wheelstop.android.surveillance.SafeLocationManager.getInstance()
                ...
                case "DELETE_SAFE_LOCATION": {
                    String zoneId = request.optString("id", null);
                    if (zoneId != null) {
                        boolean removed = app.wheelstop.android.surveillance.SafeLocationManager.getInstance()
                            .removeZone(zoneId);
                ...
                case "TOGGLE_SAFE_LOCATIONS": {
                    ...
                    app.wheelstop.android.surveillance.SafeLocationManager.getInstance().setFeatureEnabled(enabled);
                    response.put("success", true);
                    response.put("enabled", enabled);
                    break;
                }
                ...
                case app.wheelstop.android.roadsense.detect.ImuFrameCodec.COMMAND: { // "IMU_BATCH"
                ...
                case "SET_TELEMETRY_OVERLAY": {
                    ...
                    app.wheelstop.android.config.UnifiedConfigManager.setTelemetryOverlay(overlayConfig);
                    // Notify pipeline
                ...
                case "GET_TELEMETRY_OVERLAY": {
                    JSONObject overlayConfig = app.wheelstop.android.config.UnifiedConfigManager.getTelemetryOverlay();
                    response.put("success", true);
    ...
    private String applyConfigLocked(JSONObject config) {
        try {
            ...
            app.wheelstop.android.surveillance.SurveillanceEngineGpu sentry = null;
            if (pipeline != null) {
            ...
            app.wheelstop.android.surveillance.SurveillanceConfig sentryConfig = null;
            if (sentry != null) {
            ...
            if (sentryConfig == null) {
                ...
                try {
                    app.wheelstop.android.surveillance.SurveillanceConfigManager configManager =
                        new app.wheelstop.android.surveillance.SurveillanceConfigManager();
                    if (configManager.configExists()) {
                        sentryConfig = configManager.loadConfig();
                        logger.info("Loaded existing config from file for update");
                    } else {
                        sentryConfig = new app.wheelstop.android.surveillance.SurveillanceConfig();
            ...
            if (config.has("surveillanceStorageType")) {
                ...
                app.wheelstop.android.storage.StorageManager.StorageType type;
                switch (typeStr) {
                    case "SD_CARD": type = app.wheelstop.android.storage.StorageManager.StorageType.SD_CARD; break;
                    case "USB":     type = app.wheelstop.android.storage.StorageManager.StorageType.USB;     break;
                    default:        type = app.wheelstop.android.storage.StorageManager.StorageType.INTERNAL;
                }
            ...
            if (config.has("gear")) {
                ...
                logger.info("Gear changed via IPC: " + app.wheelstop.android.recording.RecordingModeManager.gearToString(gear));
            }
            ...
            if (config.has("telegramNotices")) {
                app.wheelstop.android.telegram.config.UnifiedTelegramConfig.setBoolean(
                        app.wheelstop.android.telegram.config.UnifiedTelegramConfig.K_TIER_NOTICES,
                        config.optBoolean("telegramNotices", false));
            }
            if (config.has("telegramAlerts")) {
                app.wheelstop.android.telegram.config.UnifiedTelegramConfig.setBoolean(
                        app.wheelstop.android.telegram.config.UnifiedTelegramConfig.K_TIER_ALERTS,
                        config.optBoolean("telegramAlerts", true));
            }
            if (config.has("telegramCritical")) {
                app.wheelstop.android.telegram.config.UnifiedTelegramConfig.setBoolean(
                        app.wheelstop.android.telegram.config.UnifiedTelegramConfig.K_TIER_CRITICAL,
    ...
    private JSONObject getDefaultConfig() throws Exception {
        ...
        if (pipeline != null && pipeline.getSentry() != null) {
            app.wheelstop.android.surveillance.SurveillanceEngineGpu sentry = pipeline.getSentry();
            sentryConfig = sentry.getConfig();
        }
        ...
        config.put("lastModified", app.wheelstop.android.config.UnifiedConfigManager.getLastModified());
    ...
    private JSONObject getBatteryVoltageData() throws Exception {
        app.wheelstop.android.monitor.VehicleDataMonitor monitor =
            app.wheelstop.android.monitor.VehicleDataMonitor.getInstance();
        app.wheelstop.android.monitor.BatteryVoltageData data = monitor.getBatteryVoltage();
    ...
    private JSONObject getBatteryPowerData() throws Exception {
        app.wheelstop.android.monitor.VehicleDataMonitor monitor =
            app.wheelstop.android.monitor.VehicleDataMonitor.getInstance();
        app.wheelstop.android.monitor.BatteryPowerData data = monitor.getBatteryPower();
    ...
    private JSONObject getBatterySocData() throws Exception {
        app.wheelstop.android.monitor.VehicleDataMonitor monitor =
            app.wheelstop.android.monitor.VehicleDataMonitor.getInstance();
        app.wheelstop.android.monitor.BatterySocData data = monitor.getBatterySoc();
    ...
    private JSONObject getChargingStateData() throws Exception {
        app.wheelstop.android.monitor.VehicleDataMonitor monitor =
            app.wheelstop.android.monitor.VehicleDataMonitor.getInstance();
        app.wheelstop.android.monitor.ChargingStateData data = monitor.getChargingState();
    ...
    private JSONObject getDrivingRangeData() throws Exception {
        app.wheelstop.android.monitor.VehicleDataMonitor monitor =
            app.wheelstop.android.monitor.VehicleDataMonitor.getInstance();
        app.wheelstop.android.monitor.DrivingRangeData data = monitor.getDrivingRange();
    ...
    private void handleGetMqttConnections(JSONObject response) throws Exception {
        ...
        response.put("maxConnections", app.wheelstop.android.mqtt.MqttConnectionStore.MAX_CONNECTIONS);
    }
    ...
    private void handleAddMqttConnection(JSONObject request, JSONObject response) throws Exception {
        ...
        app.wheelstop.android.mqtt.MqttConnectionConfig added = mqttManager.addConnection(request);
        if (added != null) {
            response.put("success", true);
            ...
            response.put("success", false);
            response.put("error", Messages.get("errors.max_connections_reached", app.wheelstop.android.mqtt.MqttConnectionStore.MAX_CONNECTIONS));
        }
    }
    ...
    private void handleCheckUpdate(JSONObject response) throws Exception {
        ...
        if (app.wheelstop.android.updater.AppUpdater.CHANNEL_ALPHA.equals(channel)) {
            response.put("success", true);
            response.put("available", false);
            response.put("currentVersion",
                    app.wheelstop.android.updater.AppUpdater.getDisplayVersionFromFile());
            return;
        }

        app.wheelstop.android.updater.AppUpdater updater =
                new app.wheelstop.android.updater.AppUpdater(ctx);
        final Object lock = new Object();
        final boolean[] done = {false};
        final JSONObject[] resultRef = {null};
        updater.checkForUpdate(new app.wheelstop.android.updater.AppUpdater.UpdateCallback() {
            ...
            @Override public void onError(String error) {
                ...
                try {
                    ...
                    r.put("currentVersion", app.wheelstop.android.updater.AppUpdater.getDisplayVersionFromFile());
                } catch (Exception ignored) {}
                resultRef[0] = r;
                synchronized (lock) { done[0] = true; lock.notify(); }
            }
    ...
    private void handleListVersions(JSONObject response) throws Exception {
        ...
        final boolean[] done = {false};
        final JSONObject[] resultRef = {null};
        updater.listVersions(new app.wheelstop.android.updater.AppUpdater.VersionListCallback() {
            @Override public void onResult(java.util.List<app.wheelstop.android.updater.AppUpdater.VersionEntry> versions, String currentVersion) {
                JSONObject r = new JSONObject();
                try {
                    r.put("available", true);
                    r.put("currentVersion", currentVersion);
                    org.json.JSONArray arr = new org.json.JSONArray();
                    for (app.wheelstop.android.updater.AppUpdater.VersionEntry v : versions) arr.put(v.toJson());
                    r.put("versions", arr);
                } catch (Exception ignored) {}
                resultRef[0] = r;
                synchronized (lock) { done[0] = true; lock.notify(); }
    ...
    private void handleGetChannel(JSONObject response) throws Exception {
        app.wheelstop.android.config.UnifiedConfigManager.forceReload();
        response.put("success", true);
        response.put("channel", app.wheelstop.android.config.UnifiedConfigManager.getUpdateChannel());
    }
    ...
    private void handleSetChannel(JSONObject request, JSONObject response) throws Exception {
        ...
        if (!app.wheelstop.android.updater.AppUpdater.CHANNEL_ALPHA.equals(value)
                && !app.wheelstop.android.updater.AppUpdater.CHANNEL_BRAVEHEART.equals(value)) {
            response.put("success", false);
    ...
    private void handleInstallUpdate(JSONObject request, JSONObject response) throws Exception {
        ...
        if (!app.wheelstop.android.updater.AppUpdater.tryBeginInstall()) {
            response.put("success", false);
        ...
        if (version != null && !version.isEmpty()) {
            ...
            if (!app.wheelstop.android.updater.AppUpdater.isValidAlphaTag(version)
                    || !app.wheelstop.android.updater.AppUpdater.CHANNEL_ALPHA.equals(activeChannel)) {
                app.wheelstop.android.updater.AppUpdater.endInstall();
                try { updater.close(); } catch (Exception ignored) {}
                response.put("success", false);
        ...
        try {
            ...
            try {
                ...
                try (java.io.FileWriter fw = new java.io.FileWriter(
                        app.wheelstop.android.updater.UpdateLifecycle.TELEGRAM_POST_UPDATE_HINT_FILE)) {
            ...
            new Thread(() -> {
                try {
                    updater.downloadAndInstall(new app.wheelstop.android.updater.AppUpdater.InstallCallback() {
    ...
    private static void surfaceIpcInstallFailure(String error) {
        ...
        String reason = app.wheelstop.android.telegram.TelegramMessages
                .technicalDetail(raw);
        ...
        try {
            app.wheelstop.android.telegram.TelegramNotifier.sendMessage(
                    app.wheelstop.android.telegram.TelegramMessages.get(
    ...
    private void handleUploadLog(JSONObject request, JSONObject response) throws Exception {
        ...
        String path = app.wheelstop.android.logging.DaemonLogPaths.pathFor(daemon);
        if (path == null) {
            response.put("success", false);
            response.put("error", "Unknown daemon. Try: "
                    + app.wheelstop.android.logging.DaemonLogPaths.keyList());
            return;
        }
        String version = app.wheelstop.android.updater.AppUpdater.getDisplayVersionFromFile();
        app.wheelstop.android.logging.LogUploader.Result res =
                app.wheelstop.android.logging.LogUploader.upload(path, daemon, version);
