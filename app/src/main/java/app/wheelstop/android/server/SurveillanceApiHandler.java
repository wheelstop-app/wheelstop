...
import app.wheelstop.android.surveillance.SurveillanceConfigManager;
import app.wheelstop.android.surveillance.SurveillanceEngineGpu;
import app.wheelstop.android.surveillance.MotionPipelineV2;
...
public class SurveillanceApiHandler {
    ...
    public static boolean handle(String method, String path, String body, OutputStream out) throws Exception {
        ...
        if (cleanPath.equals("/api/surveillance/screen-deterrent/test") && method.equals("POST")) {
            try {
                String error = app.wheelstop.android.surveillance.ScreenDeterrent
...
=======
    private static final String SCREEN_DETERRENT_DIR =
            app.wheelstop.android.surveillance.ScreenDeterrentAsset.DIRECTORY;
    private static final String SCREEN_DETERRENT_PREFIX =
            app.wheelstop.android.surveillance.ScreenDeterrentAsset.PREFIX;
    ...
    static String deterrentAssetExtension(byte[] data) {
        if (app.wheelstop.android.surveillance.ScreenDeterrentVideo.isMp4(data)) {
            return "mp4";
        }
...
>>>>>>> vendor/upstream
    ...
    private static boolean isAllowedDeterrentPath(String path) {
        return app.wheelstop.android.surveillance.ScreenDeterrentAsset
                .isAllowedPath(path);
    }
    ...
    private static void handleScreenDeterrentImageGet(OutputStream out) throws Exception {
        ...
        synchronized (SCREEN_DETERRENT_ASSET_LOCK) {
            String path = app.wheelstop.android.config.UnifiedConfigManager.getSurveillance()
...
>>>>>>> vendor/upstream
    ...
    private static String validateDeterrentVideoNow(java.io.File file) {
        if (!app.wheelstop.android.surveillance.ScreenDeterrentVideo
                .isMp4File(file.getAbsolutePath())) {
            return "That file is not a readable MP4";
        }
        app.wheelstop.android.surveillance.ScreenDeterrentVideo.Probe probe =
                app.wheelstop.android.surveillance.ScreenDeterrentVideo.probe(
    ...
    private static void sendConfig(OutputStream out) throws Exception {
        ...
        config.put("enabled", app.wheelstop.android.config.UnifiedConfigManager.isSurveillanceEnabled());
        ...
        if (sentryConfig != null) {
            ...
            config.put("totalBlocks", sentry != null ? sentry.getTotalBlocks()
                    : app.wheelstop.android.surveillance.MotionPipelineV2.TOTAL_BLOCKS);
        ...
        JSONObject ucmRoot = app.wheelstop.android.config.UnifiedConfigManager.forceReload();
        ...
        JSONObject bydCloud = app.wheelstop.android.config.UnifiedConfigManager.getBydCloud();
        ...
        if (sentryConfig != null) {
            ...
            config.put("telegramNotices",
                    app.wheelstop.android.telegram.config.UnifiedTelegramConfig.isTierNotices());
            config.put("telegramAlerts",
                    app.wheelstop.android.telegram.config.UnifiedTelegramConfig.isTierAlerts());
            config.put("telegramCritical",
                    app.wheelstop.android.telegram.config.UnifiedTelegramConfig.isTierCritical());
            ...
            for (int q = 0; q < 4; q++) {
                ...
                try {
                    org.json.JSONObject survCfg = app.wheelstop.android.config.UnifiedConfigManager.getSurveillance();
            ...
            try {
                ...
                for (app.wheelstop.android.surveillance.SurveillanceSchedule.Rule rule : sentryConfig.getSchedule().getRules()) {
            ...
            try {
                ...
                if (camCfg != null
                    ...
                    config.put("dilink4MosaicViewpointConfirmed",
                        app.wheelstop.android.camera.BydApaViewpointHelper.isMosaicViewpointConfirmed());
                    config.put("dilink4ViewpointRc",
                        app.wheelstop.android.camera.BydApaViewpointHelper.getLastAcquireRc());
                }
            } catch (Exception ignored) {}
        } else {
        ...
        try {
            ...
            JSONObject resolvedJson = app.wheelstop.android.camera.CameraConfigResolver
    ...
    private static void handleConfigPost(OutputStream out, String body) throws Exception {
        ...
        try {
            ...
            if (configJson.has("cameraProfile")
                ...
                String requestedProfile = configJson.optBoolean("clearCameraProfile", false)
                    ...
                    : configJson.optString("cameraProfile",
                        app.wheelstop.android.camera.CameraProfiles.PROFILE_AUTO);
                if (!app.wheelstop.android.camera.CameraConfigResolver
            ...
            if (configJson.has("cameraRoleMapping")) {
                ...
                app.wheelstop.android.camera.CameraRole role =
                    app.wheelstop.android.camera.CameraRole.fromKey(
                ...
                if (mappingJson.optBoolean("clear", false)) {
                    if (!app.wheelstop.android.camera.CameraConfigResolver.clearRoleMapping(role)) {
                        HttpResponse.sendJsonError(out, "Failed to clear role mapping");
                        return;
                    }
                } else {
                    app.wheelstop.android.camera.CameraSourceRef source =
                        app.wheelstop.android.camera.CameraSourceRef.fromJson(
            ...
            if (configJson.optBoolean("clearCameraRoleMappings", false)) {
                for (app.wheelstop.android.camera.CameraRole role
                        : app.wheelstop.android.camera.CameraRole.values()) {
                    app.wheelstop.android.camera.CameraConfigResolver.clearRoleMapping(role);
                }
            }
            ...
            if (configJson.has("deterrentAction")) {
                ...
                if ("silent".equals(action) || "flash_lights".equals(action) || "find_car".equals(action)) {
                    ...
                    try {
                        app.wheelstop.android.byd.cloud.BydCloudDeterrent.getInstance().reset();
                    } catch (Exception ignored) {}
                }
            }
            ...
            if (configJson.has("accOffMode")) {
                ...
                if ("smart".equals(mode) || "continuous".equals(mode)) {
                    String prevMode = app.wheelstop.android.config.UnifiedConfigManager
                    ...
                    boolean accOff = !app.wheelstop.android.monitor.AccMonitor.isAccOn();
                    ...
                    if (modeChanged && accOff && armed) {
                        ...
                        new Thread(() -> {
                            try {
                                ...
                                try {
                                    app.wheelstop.android.surveillance.SurveillanceSchedule sch =
...
<<<<<<< HEAD
                String existing = app.wheelstop.android.config.UnifiedConfigManager.getSurveillance()
                        .optString("screenDeterrentImagePath", "");
...
>>>>>>> vendor/upstream
                    ...
                    if (configJson.has(enabledKey)) {
                        ...
                        if (enabled && sentryConfig.getRoiPolygon(q) != null) {
                            ...
                            try {
                                ...
                                app.wheelstop.android.config.UnifiedConfigManager.setSurveillance(survCfg);
                            } catch (Exception e) {
                    ...
                    if (configJson.has(blocksKey)) {
                        ...
                        if (arr != null && arr.length() == 70) {
                            ...
                            if (anyActive) {
                                ...
                                try {
                                    app.wheelstop.android.surveillance.NativeMotion.setQuadrantRoi(q, blockMask);
            ...
            if (configJson.has("scheduleEnabled") || configJson.has("scheduleRules")) {
                try {
                    app.wheelstop.android.surveillance.SurveillanceSchedule schedule = sentryConfig.getSchedule();
                    ...
                    if (configJson.has("scheduleRules")) {
                        ...
                        for (int i = 0; i < rulesArr.length(); i++) {
                            app.wheelstop.android.surveillance.SurveillanceSchedule.Rule rule =
                                app.wheelstop.android.surveillance.SurveillanceSchedule.Rule.fromJson(rulesArr.getJSONObject(i));
                            if (rule != null) schedule.getRules().add(rule);
                        }
                    }
                    // Persist schedule to unified config
                    org.json.JSONObject survConfig = app.wheelstop.android.config.UnifiedConfigManager.getSurveillance();
                    ...
                    app.wheelstop.android.config.UnifiedConfigManager.setSurveillance(survConfig);
            ...
            if (configJson.has("manualCameraId")) {
                ...
                if (camId >= 0 && camId <= 5) {
                    ...
                    boolean saved = app.wheelstop.android.config.UnifiedConfigManager
            ...
            if (configJson.has("recordingQuality") || configJson.has("recordingBitrate") || configJson.has("recordingCodec")) {
                try {
                    ...
                    if (recordingChanged) {
                        app.wheelstop.android.config.UnifiedConfigManager.setRecording(recording);
    ...
    private static android.graphics.Bitmap getFrameFromLatestEvent() {
        try {
            app.wheelstop.android.storage.StorageManager storage = app.wheelstop.android.storage.StorageManager.getInstance();
    ...
    private static void sendCameraPreview(String path, OutputStream out) throws Exception {
        ...
        if ("direct".equalsIgnoreCase(kind)) {
            ...
            if (cameraId == resolvedCamera.getPanoCameraId() && gpuPipeline != null) {
                ...
                jpegBytes = app.wheelstop.android.camera.CameraPreviewHelper
                    .captureDirectPreviewJpeg(cameraId, width, height);
            }
        } else if ("panoramicSlice".equalsIgnoreCase(kind)) {
            app.wheelstop.android.camera.PanoramicSlice slice =
                app.wheelstop.android.camera.PanoramicSlice.fromId(getQueryParam(path, "slice"));
            if (slice == null) {
                HttpResponse.sendJsonError(out, "Invalid panoramic slice");
                return;
            }
            jpegBytes = app.wheelstop.android.camera.CameraPreviewHelper.capturePanoramicSliceJpeg(slice);
            ...
            app.wheelstop.android.camera.CameraVirtualView view =
                app.wheelstop.android.camera.CameraVirtualView.fromId(getQueryParam(path, "view"));
            if (view == null) {
                HttpResponse.sendJsonError(out, "Invalid panoramic view");
                return;
            }
            jpegBytes = app.wheelstop.android.camera.CameraPreviewHelper.capturePanoramicViewJpeg(view);
            if (jpegBytes == null && gpuPipeline != null) {
