...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/trips/OdometerReader.java
            
            // Convert miles to km if the instrument cluster is set to miles
            double factor = app.wheelstop.android.byd.BydDataCollector.getInstance().getDistanceToKmFactor();
            return value * factor;
=======
        }
    ...
    private synchronized double readFineRaw(double coarseRaw) {
        ...
        try {
            ...
            return candidate;
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/trips/OdometerReader.java
        } catch (Exception e) {
