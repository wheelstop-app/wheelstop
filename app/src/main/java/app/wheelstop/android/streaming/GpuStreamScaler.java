...
public class GpuStreamScaler {
     ...
     * (see app.wheelstop.android.od.Od) which resolves them into the sampler
    ...
    private void resolveCoef() {
        ...
        odIn[10] = odSign;
        app.wheelstop.android.od.Od.resolve(odIn, odCoef);
    }
    ...
    private static String buildFragmentShader(float[] offsets) {
        ...
        return String.format(Locale.US,
            ...
            // Resolved coefficient set (host-supplied; see app.wheelstop.android.od.Od).
            "uniform vec4 uOd0;\n" +
            "uniform vec4 uOd1;\n" +
            "uniform vec4 uOd2;\n" +
            "uniform vec4 uOd3;\n" +
