 ...
 *       once — and {@code app.wheelstop.android} is itself a launchable package that owns the head-unit
...
final class ClusterFreeformWindow {
     ...
     * a hypothetical: OverDrive declares a LAUNCHER activity, so {@code app.wheelstop.android} itself
     * appears in the cast picker — and {@code ClusterMapProjector}'s nav-map
     * ({@code app.wheelstop.android/.navmap.RoadSenseClusterMapActivity}) is the SAME package. Casting
