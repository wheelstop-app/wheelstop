...
public class StatusOverlayService extends Service {
    ...
    private void pollStatus() {
        ...
        executor.execute(() -> {
            ...
            try {
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/overlay/StatusOverlayService.java
                app.wheelstop.android.config.UnifiedConfigManager.forceReload();
=======
                com.overdrive.app.config.UnifiedConfigManager.loadConfig();
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/overlay/StatusOverlayService.java
            } catch (Throwable t) {
