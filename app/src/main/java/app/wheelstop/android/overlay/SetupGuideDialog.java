    ...
    public static void show(Context context, boolean isUpdate) {
        ...
        if (btnLanguage != null) {
            btnLanguage.setOnClickListener(v ->
                app.wheelstop.android.ui.dialog.LanguagePickerDialog.show(context, picked -> {
        ...
        if (btnTrafficMonitor != null) {
            btnTrafficMonitor.setOnClickListener(v -> {
                if (context instanceof app.wheelstop.android.ui.MainActivity) {
                    ((app.wheelstop.android.ui.MainActivity) context).invokeTrafficMonitorAction();
                }
            });
        }
