...
import app.wheelstop.android.storage.StorageSetup
...
import app.wheelstop.android.ui.privacy.ScreenshotPrivacyController
...
import app.wheelstop.android.util.BydDataCacheWhitelist
...
open class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Dilink5SdkInjector.ensure(this)
    ...
    override fun onPause() {
        ...
        if (!remoteDevSession) PinSession.notePaused()
    }
    ...
    private fun handleLocationStartIntent(intent: android.content.Intent) {
        ...
        if (action == "app.wheelstop.android.START_LOCATION_ACTIVITY" || startLocation) {
        ...
        LogManager.setLogListener(object : LogManager.LogListener {
            override fun onLog(tag: String, message: String, level: LogLevel) {
                ...
                val uiLevel = when (level) {
                    LogLevel.DEBUG -> app.wheelstop.android.ui.model.LogLevel.DEBUG
                    LogLevel.INFO -> app.wheelstop.android.ui.model.LogLevel.INFO
                    LogLevel.WARN -> app.wheelstop.android.ui.model.LogLevel.WARN
                    LogLevel.ERROR -> app.wheelstop.android.ui.model.LogLevel.ERROR
                }
...
>>>>>>> vendor/upstream
    ...
    override fun onDestroy() {
        ...
        if (!remoteDevSession) AdbShellExecutor.setAuthCallback(null)
