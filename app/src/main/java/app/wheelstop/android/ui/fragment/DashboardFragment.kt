...
class DashboardFragment : Fragment() {
    ...
    private fun wireClicks() {
        ...
        val fadeThrough = app.wheelstop.android.ui.util.NavOptionsExt.m3FadeThrough()
    ...
    private fun updateTunnelTile() {
        ...
        val display = app.wheelstop.android.ui.model.TunnelDisplayPolicy.resolve(
        ...
        when (display.kind) {
            app.wheelstop.android.ui.model.TunnelDisplayPolicy.Kind.ONLINE -> {
            ...
            app.wheelstop.android.ui.model.TunnelDisplayPolicy.Kind.STARTING_ZROK,
            app.wheelstop.android.ui.model.TunnelDisplayPolicy.Kind.STARTING_CLOUDFLARED,
            ...
            app.wheelstop.android.ui.model.TunnelDisplayPolicy.Kind.STOPPING -> {
                metricTunnelValue.text = getString(R.string.dashboard_tunnel_tile_stopping)
                tunnelStateDot.setBackgroundResource(R.drawable.status_dot_starting)
            }
            app.wheelstop.android.ui.model.TunnelDisplayPolicy.Kind.FAILED -> {
    ...
    private fun collectAvailableTunnels(): List<Pair<DaemonType, String>> {
        ...
        daemonsViewModel.cloudflaredController.tunnelUrl.value
            ?.takeIf {
                app.wheelstop.android.ui.model.TunnelDisplayPolicy.isActiveUrl(
