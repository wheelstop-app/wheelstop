...
public class SohEstimator {
    ...
    private void autoDetectCarModelInternal(
        ...
        if (context == null) {
            try {
                context = app.wheelstop.android.daemon.CameraDaemon.getAppContext();
                if (context != null) {
    ...
    private double readModelNominalFromManifest() {
        return app.wheelstop.android.server.ModelsApiHandler.nominalKwhForSelectedModel();
    }
    ...
    private void invalidateActiveTripKwhBaseline(String reason) {
        try {
            ...
            app.wheelstop.android.trips.TripRecord active = mgr.getActiveTrip();
    ...
    private void maybeFireFrameMismatchNotification() {
        ...
        try {
            ...
            String title = app.wheelstop.android.server.Messages.get(
                "notifications.soh_frame_mismatch_title");
            String body = app.wheelstop.android.server.Messages.get(
     ...
     * {@link app.wheelstop.android.byd.BydDataCollector}; the lookup is best-
