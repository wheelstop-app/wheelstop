...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/receiver/ProcessRevivalReceiver.kt
            if (app.wheelstop.android.config.UnifiedConfigManager.isVehicleOnOnlyMode()) {
=======
            if (onOnlyKnown ?: com.overdrive.app.config.UnifiedConfigManager.isVehicleOnOnlyMode()) {
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/receiver/ProcessRevivalReceiver.kt
