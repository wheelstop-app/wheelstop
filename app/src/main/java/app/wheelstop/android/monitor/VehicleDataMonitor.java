...
public class VehicleDataMonitor {
    ...
    static boolean shouldDeferExternalToGroundedEstimate(
        ...
        String source = app.wheelstop.android.byd.ChargeSourceClassifier.SRC_EXTERNAL;
    ...
    static boolean isCandidateContradictedByReference(String source,
                                                       double candidateKw,
                                                       double referenceKw) {
        return !app.wheelstop.android.byd.ChargeSourceClassifier.SRC_CAPACITY.equals(source)
    ...
    private ChargingStateData buildChargingState(
        ...
        if (effectiveState == ChargingStateData.CHARGING_BATTERY_STATE_CHARGING || taperCharging) {
            ...
            boolean clusterScaleCorroborated = app.wheelstop.android.byd.ChargeSourceClassifier
            ...
            if (nowMs - lastChargePowerLogMs > 60_000L) {
                ...
                logger.info(String.format(
                    ...
                    app.wheelstop.android.byd.ChargeSourceClassifier.kindOf(
                        app.wheelstop.android.byd.ChargeSourceClassifier.SRC_CLUSTER),
                    clusterIdleGarbage,
                    ...
                    app.wheelstop.android.charging.CounterScaleCalibrator.factorFor(
                        app.wheelstop.android.byd.ChargeSourceClassifier.SRC_CAPACITY),
                    app.wheelstop.android.charging.CounterScaleCalibrator.isScaleSuspect(
                        app.wheelstop.android.byd.ChargeSourceClassifier.SRC_CAPACITY),
                    capacityHalfScale,
