 ...
 * 
 * Note: App data directory (/data/data/app.wheelstop.android/) is NOT writable by daemon (UID 2000).
...
public class GpsMonitor {
    ...
    private static final String CACHE_FILE_APP = "/data/data/app.wheelstop.android/files/gps_cache.json";
