...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/camera/PanoramicCameraGpu.java
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/camera/PanoramicCameraGpu.java
                                    currentId,
                                    cameraSurfaceMode,
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/camera/PanoramicCameraGpu.java
     ...
     * Same pattern {@link app.wheelstop.android.surveillance.GpuDownscaler} uses
     * for the AI lane.
     *
    ...
    private synchronized HighResPreviewSampler ensureHighResSampler() {
        ...
        try {
            ...
            if (USE_ESCO_SURFACE_TEXTURE_PATH) {
                ...
                try {
                    org.json.JSONObject camCfgHr = app.wheelstop.android.config
                        .UnifiedConfigManager.loadConfig().optJSONObject("camera");
                    if (camCfgHr != null) {
