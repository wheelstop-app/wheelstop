...
public class BydCameraCoordinator {
    ...
    private void registerCameraUser() {
        ...
        cameraUser = new BydCameraUser(activeCameraId, "app.wheelstop.android");
        ...
        if (getCurrentCameraUserMethod != null && reflectionServiceProxy != null) {
            try {
                ...
                if (currentUser != null) {
                    ...
                    if (pkg != null && !"app.wheelstop.android".equals(pkg)) return pkg;
                }
    ...
    public boolean checkNativeAppActive() {
        ...
        try {
            ...
            if (currentUser != null) {
                ...
                boolean isUs = "app.wheelstop.android".equals(pkg);
