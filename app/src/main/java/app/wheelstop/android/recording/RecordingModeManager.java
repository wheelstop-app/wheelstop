...
import app.wheelstop.android.proximity.ProximityGuardController;
...
public class RecordingModeManager {
    ...
    private void activateModeBody(Mode mode) {
        ...
        try {
            dilink4FpsSkip = app.wheelstop.android.daemon.CameraDaemon.isDilink4ModeActiveStatic();
        } catch (Throwable ignored) {}
        ...
        switch (mode) {
            case NONE:
                ...
                // mode=NONE; only legacy tears down for resource saving.
                {
                    ...
                    try {
                        dilink4None = app.wheelstop.android.daemon.CameraDaemon.isDilink4ModeActiveStatic();
                    } catch (Throwable ignored) {}
            ...
            try {
                ...
                if (level >= 0 && level <= 3) {
                    ...
                    boolean ipcAuthoritative =
                        app.wheelstop.android.monitor.AccMonitor.isAccStateAuthoritative();
                    boolean ipcCurrent =
...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/recording/RecordingModeManager.java
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/recording/RecordingModeManager.java
                        return false;
                    }
                    ...
                    if (!ipcAuthoritative || ipcCurrent != isOn) {
                        ...
                        app.wheelstop.android.monitor.AccMonitor.setAccState(isOn);
                    } else {
