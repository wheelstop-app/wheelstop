...
import app.wheelstop.android.ai.YoloDetector;
        ...
        try {
            ...
            if (context != null) {
                ...
                try {
                    ...
                    android.content.Context assetContext = new app.wheelstop.android.ai.AssetContext(assetManager);
...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/surveillance/SurveillanceEngineGpu.java
        if (app.wheelstop.android.config.UnifiedConfigManager.isSurveillanceIdleThrottle()) {
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/surveillance/SurveillanceEngineGpu.java
        ...
        if (app.wheelstop.android.BuildConfig.DEBUG && frameCount % 100 == 0) {
            ...
            if (motionDuration >= requiredDuration) {
                ...
                if (!recording) {
                    ...
                    // prevents rapid-fire false triggers, so the cooldown is unnecessary.
                        ...
                        try {
                            app.wheelstop.android.byd.cloud.BydCloudDeterrent.getInstance().onMotionDetected();
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/surveillance/SurveillanceEngineGpu.java
                ...
                if (detections != null && !detections.isEmpty()) {
                    ...
                    java.util.List<app.wheelstop.android.ai.Detection> motionFiltered = new java.util.ArrayList<>();
                    for (app.wheelstop.android.ai.Detection det : detections) {
...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/surveillance/SurveillanceEngineGpu.java
                        ...
                        java.util.List<app.wheelstop.android.ai.Detection> cqtDetections;
                        if (usedFoveated) {
                            cqtDetections = new java.util.ArrayList<>(motionFiltered.size());
                            float scaleToQuad = 320.0f / FoveatedCropper.CROP_SIZE;  // 0.5
                            for (app.wheelstop.android.ai.Detection det : motionFiltered) {
                                cqtDetections.add(new app.wheelstop.android.ai.Detection(
=======
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/surveillance/SurveillanceEngineGpu.java
     ...
     * {@link app.wheelstop.android.camera.CameraProfile}.
     */
     ...
     * {@link app.wheelstop.android.camera.CameraProfile}'s
    ...
    private boolean isInTileEdgeBand(java.util.List<app.wheelstop.android.ai.Detection> dets,
                                     int frameH) {
        ...
        app.wheelstop.android.ai.Detection closest = null;
    ...
    private void sendRichMotionNotifications(String videoFilename) {
        ...
        if (!app.wheelstop.android.notifications.NotificationGate.shouldTelegram(peakSev, config)) {
    ...
    private void sendFinalTelegramNotification(String videoFilename, String heroPhotoPath) {
        ...
        boolean snapOk = app.wheelstop.android.notifications.NotificationGate.shouldTelegram(peakSev, config);
        ...
        boolean peakOk = eventPeakSeverity != null
                && app.wheelstop.android.notifications.NotificationGate.shouldTelegram(eventPeakSeverity, config);
        ...
        try {
            ...
            app.wheelstop.android.notifications.NotificationBus.get().publish(
                    new app.wheelstop.android.notifications.NotificationEvent(
                            ...
                            app.wheelstop.android.notifications.NotificationEvent.Severity.INFO,
                            title,
                            body,
...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/surveillance/SurveillanceEngineGpu.java
            app.wheelstop.android.automation.Automations.update(
                    app.wheelstop.android.automation.condition.BydEvent.SURVEILLANCE_THREAT, sev);
            ...
            app.wheelstop.android.automation.Automations.update(
                    app.wheelstop.android.automation.condition.BydEvent.SURVEILLANCE_OBJECT, obj);
=======
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/surveillance/SurveillanceEngineGpu.java
    ...
    private void resetSurveillanceAutomationState() {
        try {
            app.wheelstop.android.automation.Automations.update(
                    app.wheelstop.android.automation.condition.BydEvent.SURVEILLANCE_THREAT, "notice");
            app.wheelstop.android.automation.Automations.update(
                    app.wheelstop.android.automation.condition.BydEvent.SURVEILLANCE_OBJECT, "none");
        } catch (Throwable t) {
        ...
        try {
            ...
            try {
                ...
                if (enc != null && enc.hasStartGeo()) {
                    ...
                    app.wheelstop.android.geo.PlaceResult place =
            ...
            if (videoFilename != null) {
                ...
                String thumbTok = app.wheelstop.android.auth.AuthManager
            ...
            app.wheelstop.android.notifications.NotificationEvent.Severity nsev;
            if (peakSev == Actor.Severity.CRITICAL) {
                nsev = app.wheelstop.android.notifications.NotificationEvent.Severity.CRITICAL;
            } else if (peakSev == Actor.Severity.ALERT) {
                nsev = app.wheelstop.android.notifications.NotificationEvent.Severity.WARN;
            } else {
                nsev = app.wheelstop.android.notifications.NotificationEvent.Severity.INFO;
            }
            ...
            app.wheelstop.android.notifications.NotificationEvent ev =
                    new app.wheelstop.android.notifications.NotificationEvent(
                            subCategory,
                            nsev,
                            title,
            ...
            app.wheelstop.android.notifications.NotificationBus.get().publish(ev);
        } catch (Throwable t) {
    ...
    private void startContinuousRecording() {
        ...
        try {
            storageManager = app.wheelstop.android.storage.StorageManager.getInstance();
            app.wheelstop.android.storage.StorageManager.StorageType type =
                    storageManager.getSurveillanceStorageType();
            if (type == app.wheelstop.android.storage.StorageManager.StorageType.SD_CARD
            ...
            } else if (type == app.wheelstop.android.storage.StorageManager.StorageType.USB
...
<<<<<<< HEAD:app/src/main/java/app/wheelstop/android/surveillance/SurveillanceEngineGpu.java
        final app.wheelstop.android.storage.StorageManager smRef = storageManager;
        if (smRef != null) {
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/surveillance/SurveillanceEngineGpu.java
    ...
    private void stopContinuousRecording() {
        ...
        app.wheelstop.android.geo.GeoSnapshot finalStartGeo = null;
        try {
            HardwareEventRecorderGpu enc = recorder.getEncoder();
            if (enc != null && enc.hasStartGeo()) {
                finalStartGeo = new app.wheelstop.android.geo.GeoSnapshot(
        ...
        try {
            ...
            int curGen = app.wheelstop.android.daemon.CameraDaemon
        ...
        if (finalSegment != null) {
            try {
                app.wheelstop.android.geo.GeoSnapshot startGeo = finalStartGeo != null
                        ? finalStartGeo
...
>>>>>>> upstream/main:app/src/main/java/com/overdrive/app/surveillance/SurveillanceEngineGpu.java
        ...
        try {
            ...
            String oemSurvMode = app.wheelstop.android.config.UnifiedConfigManager
            ...
            if (oemSurvEnabled) {
                ...
                if (oemPipe != null && oemPipe.isRunning()) {
                    ...
                    int gen = app.wheelstop.android.daemon.CameraDaemon
                        .getOemDashcamPipelineGeneration();
    ...
    private void discardCurrentEvent() {
        ...
        for (File seg : eventSegmentFiles) {
            ...
            try {
                app.wheelstop.android.server.RecordingsApiHandler.deleteEventSidecars(seg, seg.getName());
            } catch (Throwable t) {
        ...
        try {
            ...
            app.wheelstop.android.server.RecordingsApiHandler.deleteEventSidecars(f, name);
        } catch (Throwable t) {
    ...
    private void scheduleSegmentMetadataFlushWithSnapshot(
        ...
        try {
            ...
            app.wheelstop.android.geo.GeoSnapshot startGeo =
                    app.wheelstop.android.geo.GeoSnapshot.empty();
            app.wheelstop.android.geo.GeoSnapshot peakGeo  = null;
            try {
                HardwareEventRecorderGpu enc = (recorder != null) ? recorder.getEncoder() : null;
                if (enc != null) {
            ...
            if (segmentActors != null) {
                ...
                if (peakRelMs >= 0) {
                    peakGeo = app.wheelstop.android.geo.GeoSnapshot.capture(peakRelMs);
                }
            }
    ...
    public void enable() {
        ...
        try {
            app.wheelstop.android.automation.Automations.update(
                    app.wheelstop.android.automation.condition.BydEvent.SURVEILLANCE_ARMED, "on");
        } catch (Throwable ignored) {}
        resetSurveillanceAutomationState();
        ...
        // user toggle.
        try {
            org.json.JSONObject surv = app.wheelstop.android.config.UnifiedConfigManager
