...
public final class ClusterViewMirrorService extends Binder {
    ...
    public static final String SERVICE_NAME = "wheelstop_cluster_view";
    ...
    public static final String DESCRIPTOR = "app.wheelstop.android.cluster.IClusterViewMirror";
    ...
    private int attach(Surface surface, Rect box, int mode, IBinder owner,
        ...
        final long castGenerationAtAttach =
                app.wheelstop.android.launcher.ClusterCast.currentSessionGeneration();
        synchronized (lock) {
    ...
    private void handleOwnerDeath(OwnerDeath death) {
        ...
        new Thread(() -> {
            ...
            try { app.wheelstop.android.launcher.ClusterCast.stopIfSession(castGeneration); }
            catch (Throwable t) {
