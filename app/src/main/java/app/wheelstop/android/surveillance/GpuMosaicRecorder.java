...
public class GpuMosaicRecorder {
    ...
    public boolean startRecording(String outputPath) {
        synchronized (recordingLock) {
            ...
            if (encoder != null && encoder.triggerEventRecording(outputPath, 5000)) {  // Default 5 sec post-record
                ...
                try {
                    app.wheelstop.android.storage.StorageManager.getInstance().setRecordingActive(true);
                } catch (Exception e) {
    ...
    public void startRecording(java.io.File outputDir, String prefix) {
        ...
        try {
            ...
            startRecording("/storage/emulated/0/Android/data/app.wheelstop.android/files/" + filename);
        }
    }
    ...
    private void reconcileOverlayWorker() {
        ...
        if (active) {
            ...
            app.wheelstop.android.byd.BydDataCollector.setOverlayBeamDemand(overlayDemandKey, false);
            r.stopWorker();
        }
    }
