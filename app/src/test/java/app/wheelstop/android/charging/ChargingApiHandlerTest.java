...
public class ChargingApiHandlerTest {
    ...
    private static final class TrackingTripManager
        ...
        private final app.wheelstop.android.trips.TripConfig tripConfig =
                new app.wheelstop.android.trips.TripConfig();

        @Override
        public app.wheelstop.android.trips.TripConfig getConfig() {
            return tripConfig;
        }
